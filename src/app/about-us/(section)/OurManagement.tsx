        ...
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-[#050505] md:flex-row lg:px-24 lg:py-20">
          ...
          <div className="flex h-full w-full flex-col items-center gap-[2.5rem] p-6 md:w-1/2 md:items-start lg:ml-24">
            <p className="max-w-[450px] text-center font-light leading-[160%] text-[#C1B6A6] md:text-start">
              Welcome to Bavette. From the very beginning, our vision was to
              ...
              <br />
              <br />
              At Bavette, we believe dining should be more than just a meal—it
              ...
              magic for you. We look forward to making every visit to Bavette as
            ...
            <div>
              ...
              <p className="font-manrope font-thin text-[#C1B6A6]">
                Managing Director
              </p>
            </div>
          </div>
        ...
        <div className="flex w-full flex-col gap-6 lg:flex-row lg:justify-center lg:gap-9">
          <div className="flex w-full flex-col gap-4 lg:w-fit">
            ...
            <div className="w-full lg:w-fit">
              ...
              <p className="text-center font-manrope font-thin text-[#C1B6A6] lg:text-start">
                Managing Director
              </p>
            </div>
          </div>
