  ...
  return (
    <section className="flex h-full min-h-[90vh] w-full max-w-[1300px] flex-col gap-4 pt-4">
          ...
          <div className="custom-scrollbar flex w-full flex-1 flex-col gap-4 overflow-y-scroll py-4 pl-4 pr-4">
            {cartItems.map((item, index) => (
              <div
                ...
                className={`flex max-h-[150px] w-full items-center justify-between gap-2 py-4 ${
      ...
      <div className="fixed bottom-0 flex w-full max-w-[1300px] gap-3 px-4 py-3">
        <Button
          type="button"
          className="w-1/2 cursor-pointer justify-center rounded-md"
          variant="outline"
          onClick={() => router.back()}
        >
          Back
        ...
        <Button
          type="submit"
          className={cn(
            "w-1/2 justify-between rounded-md",
